...
def _argminmax_shape_rule(operand, *, axes, index_dtype):
  axis, = axes
  if core.is_empty_shape(operand.shape):
    raise ValueError("argmin and argmax require non-empty operand")
